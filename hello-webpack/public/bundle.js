...
/***/ function(module, exports, __webpack_require__) {
	...
	React.createElement(Greeter, { name: data, message: 'Message from prop!' }), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Greeter = React.createClass({
	  ...
	  handleNewForm: function handleNewForm(update) {
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(GreeterForm, { onNewFormChange: this.handleNewForm })
	    );
	  }
	});
